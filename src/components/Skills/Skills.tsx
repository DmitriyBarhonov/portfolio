...
export const Skills = () => {
    const testDescription = " Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean eget risus tellus.Integer faucibus auctor tellus, ac porttitor dui dictum quis"
